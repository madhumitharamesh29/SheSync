...
const AddImgWrapp2 = styled.div`
	...
	img {
		...
		height: auto;
		border-radius: 1rem;
		box-shadow: 0 2px 15px rgba(246, 0, 115, 0.3);
		-webkit-box-shadow: 0 2px 15px rgba(29, 175, 192, 0.3);
		-moz-box-shadow: 0 2px 15px rgba(187, 50, 148, 0.3);
	}
`;
const AddImgWrapp3 = styled.div`
	...
	img {
		...
		height: auto;
		border-radius: 1rem;
		box-shadow: 0 2px 15px rgba(29, 187, 204, 0.3);
		-webkit-box-shadow: 0 2px 15px rgba(137, 27, 187, 0.3);
		-moz-box-shadow: 0 2px 15px rgba(162, 18, 146, 0.3);
	}
`;
